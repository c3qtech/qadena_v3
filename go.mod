...
replace (
	// RAV copied github cosmos-sdk v50.0.6 to local, no changes for now
	//	github.com/cosmos/cosmos-sdk => ./cosmos-sdk/v0.50.6/cosmos-sdk
	// RAV copied github evmos v18.1.0 to local, moved some of the test files into MOVED_TESTS to make it possible to import some evmos packages into qadena
	//	github.com/evmos/evmos/v18 => ./evmos/v18.1.0
