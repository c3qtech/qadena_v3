#!/bin/zsh
#
# eKYC PH -- foundation side, verify.
#
# A THIN WRAPPER, DELIBERATELY.  The implementation is sec_veritas_verify.sh, which is
...
#     foundation_scripts/sec_veritas_verify.sh --help
...
export QADENA_PROG="ekycph_verify.sh"
exec "$HERE/sec_veritas_verify.sh" --deployment ekycph "$@"
