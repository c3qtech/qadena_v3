#!/bin/zsh
#
# eKYC PH -- foundation side, after_step_1.
#
# A THIN WRAPPER, DELIBERATELY.  The implementation is sec_veritas_after_step_1.sh, which is
...
#     foundation_scripts/sec_veritas_after_step_1.sh --help
...
export QADENA_PROG="ekycph_after_step_1.sh"
exec "$HERE/sec_veritas_after_step_1.sh" --deployment ekycph "$@"
