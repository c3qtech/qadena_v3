...
#
# Usage:
#   ./gen_key_env_vars.sh [KEY_DIR] > uat-keys.env
#
...
MAPPINGS="
# secdsvs-eph config|secdsvs-names|SEC_DSVS_EPH_USERNAME|secdsvs-keys|SEC_DSVS_EPH_PRIVATE_KEY
#secdsvssrvprv config|secdsvssrvprv-names|SEC_DSVS_SRV_PRV_USERNAME|secdsvssrvprv-keys|SEC_DSVS_SRV_PRV_PRIVATE_KEY
#secidentitysrvprv config|secidentitysrvprv-names|SEC_IDENTITY_SRV_PRV_USERNAME|secidentitysrvprv-keys|SEC_IDENTITY_SRV_PRV_PRIVATE_KEY
# pioneer sponsor config|sec-create-wallet-sponsor-names|SEC_CREATE_WALLET_SPONSOR_USERNAME|sec-create-wallet-sponsor-keys|SEC_CREATE_WALLET_SPONSOR_PRIVATE_KEY
#secdsvs-eph-credential config|secdsvs-credential-names|SEC_DSVS_EPH_CREDENTIAL_USERNAME|secdsvs-credential-keys|SEC_DSVS_EPH_CREDENTIAL_PRIVATE_KEY
"
...
missing=0
for stem in secdsvs-names secdsvs-keys secdsvssrvprv-names secdsvssrvprv-keys \
	secidentitysrvprv-names secidentitysrvprv-keys \
	sec-create-wallet-sponsor-names sec-create-wallet-sponsor-keys \
	secdsvs-credential-names secdsvs-credential-keys; do
