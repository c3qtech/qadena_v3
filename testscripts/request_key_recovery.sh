...
qadenad_alias tx qadena create-wallet recover-al "$pioneer" --account-mnemonic="$recoveralmnemonic" create-wallet-sponsor --yes
...
qadenad_alias tx qadena create-wallet recover-ann "$pioneer" --account-mnemonic="$recoverannmnemonic" create-wallet-sponsor --yes
...
qadenad_alias tx qadena create-wallet recover-victor "$pioneer" --account-mnemonic="$recovervictormnemonic" create-wallet-sponsor --yes
...
qadenad_alias tx qadena create-wallet recover-jill "$pioneer" --account-mnemonic="$recoverjillmnemonic" create-wallet-sponsor --yes
