...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"qadena", "pricefeed", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Price_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"qadena", "pricefeed", "price", "marketId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Prices_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"qadena", "pricefeed", "prices"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_RawPrices_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"qadena", "pricefeed", "raw_prices", "marketId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Oracles_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"qadena", "pricefeed", "oracles", "marketId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Markets_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"qadena", "pricefeed", "markets"}, "", runtime.AssumeColonVerbOpt(false)))
)
