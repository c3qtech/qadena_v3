...
type QueryEnclaveMeasurementRequest struct {
}

func (m *QueryEnclaveMeasurementRequest) Reset()         { *m = QueryEnclaveMeasurementRequest{} }
func (m *QueryEnclaveMeasurementRequest) String() string { return proto.CompactTextString(m) }
func (*QueryEnclaveMeasurementRequest) ProtoMessage()    {}
func (*QueryEnclaveMeasurementRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{46}
}
func (m *QueryEnclaveMeasurementRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryEnclaveMeasurementRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryEnclaveMeasurementRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryEnclaveMeasurementRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryEnclaveMeasurementRequest.Merge(m, src)
}
func (m *QueryEnclaveMeasurementRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryEnclaveMeasurementRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryEnclaveMeasurementRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryEnclaveMeasurementRequest proto.InternalMessageInfo

type QueryEnclaveMeasurementResponse struct {
	...
	// Whether this enclave holds a trusted set at all.  A seed with none cannot bootstrap anyone,
	// and saying so here turns a silent, much later failure into a precondition the joiner reports.
	Bootstrapped bool `protobuf:"varint,5,opt,name=bootstrapped,proto3" json:"bootstrapped,omitempty"`
}

func (m *QueryEnclaveMeasurementResponse) Reset()         { *m = QueryEnclaveMeasurementResponse{} }
func (m *QueryEnclaveMeasurementResponse) String() string { return proto.CompactTextString(m) }
func (*QueryEnclaveMeasurementResponse) ProtoMessage()    {}
func (*QueryEnclaveMeasurementResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{47}
}
func (m *QueryEnclaveMeasurementResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryEnclaveMeasurementResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryEnclaveMeasurementResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryEnclaveMeasurementResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryEnclaveMeasurementResponse.Merge(m, src)
}
func (m *QueryEnclaveMeasurementResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryEnclaveMeasurementResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryEnclaveMeasurementResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryEnclaveMeasurementResponse proto.InternalMessageInfo

func (m *QueryEnclaveMeasurementResponse) GetUniqueID() string {
	if m != nil {
		return m.UniqueID
	}
	return ""
...
func (m *QueryEnclaveMeasurementResponse) GetSignerID() string {
	if m != nil {
		return m.SignerID
	}
	return ""
...
func (m *QueryEnclaveMeasurementResponse) GetProductID() string {
	if m != nil {
		return m.ProductID
	}
	return ""
...
func (m *QueryEnclaveMeasurementResponse) GetVersion() string {
	if m != nil {
		return m.Version
	}
	return ""
...
func (m *QueryEnclaveMeasurementResponse) GetBootstrapped() bool {
	if m != nil {
...
type QueryEnclaveSyncEnclaveRequest struct {
	...
	// Paging.  maxBytes == 0 means "this caller predates paging" and selects the legacy unpaged
	// reply, which is what keeps a NEW joiner working against an OLD seed during an upgrade window --
	// and sync-enclave is precisely a path where the two ends are expected to differ in version.
...
func (m *QueryEnclaveSyncEnclaveRequest) GetCursor() []byte {
	if m != nil {
		return m.Cursor
	}
	return nil
...
func (m *QueryEnclaveSyncEnclaveRequest) GetMaxBytes() uint32 {
	if m != nil {
		return m.MaxBytes
	}
	return 0
...
type QueryEnclaveSyncEnclaveResponse struct {
	RemoteReport []byte `protobuf:"bytes,1,opt,name=remoteReport,proto3" json:"remoteReport,omitempty"`
	// Legacy, unpaged: EncryptableSharedEnclaveParams with SSIntervalOwners inline.  Still sent when
	// the request carries maxBytes == 0.
	...
	// Paged: EncryptableSyncEnclavePage.  The remoteReport above certifies exactly these bytes.
	EncSyncEnclavePagePubK []byte `protobuf:"bytes,3,opt,name=encSyncEnclavePagePubK,proto3" json:"encSyncEnclavePagePubK,omitempty"`
}
...
func (m *QueryEnclaveSyncEnclaveResponse) GetEncSyncEnclavePagePubK() []byte {
	if m != nil {
		return m.EncSyncEnclavePagePubK
	}
	return nil
}

type QueryEnclavePrivateStateRequest struct {
	RemoteReport  []byte `protobuf:"bytes,1,opt,name=remoteReport,proto3" json:"remoteReport,omitempty"`
	EnclavePubK   string `protobuf:"bytes,2,opt,name=enclavePubK,proto3" json:"enclavePubK,omitempty"`
	Height        int64  `protobuf:"varint,3,opt,name=height,proto3" json:"height,omitempty"`
	WindowSeconds int64  `protobuf:"varint,4,opt,name=windowSeconds,proto3" json:"windowSeconds,omitempty"`
	BlockTimeUnix int64  `protobuf:"varint,5,opt,name=blockTimeUnix,proto3" json:"blockTimeUnix,omitempty"`
	// opaque; empty starts at the beginning.  Carries a PLAINTEXT logical key, because MustSeal is
	// nondeterministic and stable-sealed ordering is per-node, so a sealed key would not be a stable
	// position -- the server re-seals it with its own secret to seek.
	Cursor   []byte `protobuf:"bytes,6,opt,name=cursor,proto3" json:"cursor,omitempty"`
	MaxBytes uint32 `protobuf:"varint,7,opt,name=maxBytes,proto3" json:"maxBytes,omitempty"`
}

func (m *QueryEnclavePrivateStateRequest) Reset()         { *m = QueryEnclavePrivateStateRequest{} }
func (m *QueryEnclavePrivateStateRequest) String() string { return proto.CompactTextString(m) }
func (*QueryEnclavePrivateStateRequest) ProtoMessage()    {}
func (*QueryEnclavePrivateStateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{50}
}
func (m *QueryEnclavePrivateStateRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryEnclavePrivateStateRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryEnclavePrivateStateRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryEnclavePrivateStateRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryEnclavePrivateStateRequest.Merge(m, src)
}
func (m *QueryEnclavePrivateStateRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryEnclavePrivateStateRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryEnclavePrivateStateRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryEnclavePrivateStateRequest proto.InternalMessageInfo

func (m *QueryEnclavePrivateStateRequest) GetRemoteReport() []byte {
	if m != nil {
		return m.RemoteReport
	}
	return nil
...
func (m *QueryEnclavePrivateStateRequest) GetEnclavePubK() string {
	if m != nil {
		return m.EnclavePubK
	}
	return ""
...
func (m *QueryEnclavePrivateStateRequest) GetHeight() int64 {
	if m != nil {
		return m.Height
	}
	return 0
...
func (m *QueryEnclavePrivateStateRequest) GetWindowSeconds() int64 {
	if m != nil {
...
func (m *QueryEnclavePrivateStateRequest) GetBlockTimeUnix() int64 {
	if m != nil {
...
func (m *QueryEnclavePrivateStateRequest) GetCursor() []byte {
	if m != nil {
		return m.Cursor
	}
	return nil
...
func (m *QueryEnclavePrivateStateRequest) GetMaxBytes() uint32 {
	if m != nil {
		return m.MaxBytes
	}
	return 0
...
type QueryEnclavePrivateStateResponse struct {
	RemoteReport []byte `protobuf:"bytes,1,opt,name=remoteReport,proto3" json:"remoteReport,omitempty"`
	// gzip(EnclavePrivateStatePage) encrypted to the requester's enclavePubK.  The remoteReport
	// above certifies exactly these bytes.
	EncPrivateStatePagePubK []byte `protobuf:"bytes,2,opt,name=encPrivateStatePagePubK,proto3" json:"encPrivateStatePagePubK,omitempty"`
}

func (m *QueryEnclavePrivateStateResponse) Reset()         { *m = QueryEnclavePrivateStateResponse{} }
func (m *QueryEnclavePrivateStateResponse) String() string { return proto.CompactTextString(m) }
func (*QueryEnclavePrivateStateResponse) ProtoMessage()    {}
func (*QueryEnclavePrivateStateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{51}
}
func (m *QueryEnclavePrivateStateResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryEnclavePrivateStateResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryEnclavePrivateStateResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryEnclavePrivateStateResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryEnclavePrivateStateResponse.Merge(m, src)
}
func (m *QueryEnclavePrivateStateResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryEnclavePrivateStateResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryEnclavePrivateStateResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryEnclavePrivateStateResponse proto.InternalMessageInfo

func (m *QueryEnclavePrivateStateResponse) GetRemoteReport() []byte {
	if m != nil {
		return m.RemoteReport
	}
	return nil
...
func (m *QueryEnclavePrivateStateResponse) GetEncPrivateStatePagePubK() []byte {
	if m != nil {
		return m.EncPrivateStatePagePubK
	}
	return nil
}

type QueryEnclavePrivateStateAvailabilityRequest struct {
}

func (m *QueryEnclavePrivateStateAvailabilityRequest) Reset() {
	*m = QueryEnclavePrivateStateAvailabilityRequest{}
}
func (m *QueryEnclavePrivateStateAvailabilityRequest) String() string {
	return proto.CompactTextString(m)
}
func (*QueryEnclavePrivateStateAvailabilityRequest) ProtoMessage() {}
func (*QueryEnclavePrivateStateAvailabilityRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{52}
}
func (m *QueryEnclavePrivateStateAvailabilityRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryEnclavePrivateStateAvailabilityRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryEnclavePrivateStateAvailabilityRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryEnclavePrivateStateAvailabilityRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryEnclavePrivateStateAvailabilityRequest.Merge(m, src)
}
func (m *QueryEnclavePrivateStateAvailabilityRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryEnclavePrivateStateAvailabilityRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryEnclavePrivateStateAvailabilityRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryEnclavePrivateStateAvailabilityRequest proto.InternalMessageInfo

type QueryEnclavePrivateStateAvailabilityResponse struct {
	EarliestHeight int64  `protobuf:"varint,1,opt,name=earliestHeight,proto3" json:"earliestHeight,omitempty"`
	PreparedHeight int64  `protobuf:"varint,2,opt,name=preparedHeight,proto3" json:"preparedHeight,omitempty"`
	SchemaVersion  uint32 `protobuf:"varint,3,opt,name=schemaVersion,proto3" json:"schemaVersion,omitempty"`
}

func (m *QueryEnclavePrivateStateAvailabilityResponse) Reset() {
	*m = QueryEnclavePrivateStateAvailabilityResponse{}
}
func (m *QueryEnclavePrivateStateAvailabilityResponse) String() string {
	return proto.CompactTextString(m)
}
func (*QueryEnclavePrivateStateAvailabilityResponse) ProtoMessage() {}
func (*QueryEnclavePrivateStateAvailabilityResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{53}
}
func (m *QueryEnclavePrivateStateAvailabilityResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryEnclavePrivateStateAvailabilityResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryEnclavePrivateStateAvailabilityResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryEnclavePrivateStateAvailabilityResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryEnclavePrivateStateAvailabilityResponse.Merge(m, src)
}
func (m *QueryEnclavePrivateStateAvailabilityResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryEnclavePrivateStateAvailabilityResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryEnclavePrivateStateAvailabilityResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryEnclavePrivateStateAvailabilityResponse proto.InternalMessageInfo

func (m *QueryEnclavePrivateStateAvailabilityResponse) GetEarliestHeight() int64 {
	if m != nil {
...
func (m *QueryEnclavePrivateStateAvailabilityResponse) GetPreparedHeight() int64 {
	if m != nil {
...
func (m *QueryEnclavePrivateStateAvailabilityResponse) GetSchemaVersion() uint32 {
	if m != nil {
...
// The requester's report certifies enclavePubK|pubKID|"whohas" -- the literal domain tag keeps a
// share-fetch report from being replayed into a privK fetch.  The reply's report certifies
// "whohas|"+ciphertext for the same reason in the other direction.
type QueryEnclaveSecretSharePrivKRequest struct {
	RemoteReport []byte `protobuf:"bytes,1,opt,name=remoteReport,proto3" json:"remoteReport,omitempty"`
	EnclavePubK  string `protobuf:"bytes,2,opt,name=enclavePubK,proto3" json:"enclavePubK,omitempty"`
	PubKID       string `protobuf:"bytes,3,opt,name=pubKID,proto3" json:"pubKID,omitempty"`
}

func (m *QueryEnclaveSecretSharePrivKRequest) Reset()         { *m = QueryEnclaveSecretSharePrivKRequest{} }
func (m *QueryEnclaveSecretSharePrivKRequest) String() string { return proto.CompactTextString(m) }
func (*QueryEnclaveSecretSharePrivKRequest) ProtoMessage()    {}
func (*QueryEnclaveSecretSharePrivKRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{56}
}
func (m *QueryEnclaveSecretSharePrivKRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryEnclaveSecretSharePrivKRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryEnclaveSecretSharePrivKRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryEnclaveSecretSharePrivKRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryEnclaveSecretSharePrivKRequest.Merge(m, src)
}
func (m *QueryEnclaveSecretSharePrivKRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryEnclaveSecretSharePrivKRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryEnclaveSecretSharePrivKRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryEnclaveSecretSharePrivKRequest proto.InternalMessageInfo

func (m *QueryEnclaveSecretSharePrivKRequest) GetRemoteReport() []byte {
	if m != nil {
		return m.RemoteReport
	}
	return nil
...
func (m *QueryEnclaveSecretSharePrivKRequest) GetEnclavePubK() string {
	if m != nil {
		return m.EnclavePubK
	}
	return ""
...
func (m *QueryEnclaveSecretSharePrivKRequest) GetPubKID() string {
	if m != nil {
		return m.PubKID
	}
	return ""
...
type QueryEnclaveSecretSharePrivKResponse struct {
	RemoteReport        []byte `protobuf:"bytes,1,opt,name=remoteReport,proto3" json:"remoteReport,omitempty"`
	EncPrivKEnclavePubK []byte `protobuf:"bytes,2,opt,name=encPrivKEnclavePubK,proto3" json:"encPrivKEnclavePubK,omitempty"`
}

func (m *QueryEnclaveSecretSharePrivKResponse) Reset()         { *m = QueryEnclaveSecretSharePrivKResponse{} }
func (m *QueryEnclaveSecretSharePrivKResponse) String() string { return proto.CompactTextString(m) }
func (*QueryEnclaveSecretSharePrivKResponse) ProtoMessage()    {}
func (*QueryEnclaveSecretSharePrivKResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{57}
}
func (m *QueryEnclaveSecretSharePrivKResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryEnclaveSecretSharePrivKResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryEnclaveSecretSharePrivKResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryEnclaveSecretSharePrivKResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryEnclaveSecretSharePrivKResponse.Merge(m, src)
}
func (m *QueryEnclaveSecretSharePrivKResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryEnclaveSecretSharePrivKResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryEnclaveSecretSharePrivKResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryEnclaveSecretSharePrivKResponse proto.InternalMessageInfo

func (m *QueryEnclaveSecretSharePrivKResponse) GetRemoteReport() []byte {
	if m != nil {
		return m.RemoteReport
	}
	return nil
...
func (m *QueryEnclaveSecretSharePrivKResponse) GetEncPrivKEnclavePubK() []byte {
	if m != nil {
		return m.EncPrivKEnclavePubK
	}
	return nil
}
...
func (*QueryEnclaveRecoverKeyShareRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{58}
}
...
func (*QueryEnclaveRecoverKeyShareResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{59}
}
...
func (*QueryFindCredentialRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{60}
}
...
func (*QueryFindCredentialResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{61}
}
...
func (*QueryGetEnclaveIdentityRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{62}
}
...
func (*QueryGetEnclaveIdentityResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{63}
}
...
func (*QueryAllEnclaveIdentityRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{64}
}
...
func (*QueryAllEnclaveIdentityResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{65}
}
...
type QueryGetScannedContractWhitelistRequest struct {
	Address string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`
}

func (m *QueryGetScannedContractWhitelistRequest) Reset() {
	*m = QueryGetScannedContractWhitelistRequest{}
}
func (m *QueryGetScannedContractWhitelistRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGetScannedContractWhitelistRequest) ProtoMessage()    {}
func (*QueryGetScannedContractWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{66}
}
func (m *QueryGetScannedContractWhitelistRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetScannedContractWhitelistRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetScannedContractWhitelistRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetScannedContractWhitelistRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetScannedContractWhitelistRequest.Merge(m, src)
}
func (m *QueryGetScannedContractWhitelistRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetScannedContractWhitelistRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetScannedContractWhitelistRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetScannedContractWhitelistRequest proto.InternalMessageInfo

func (m *QueryGetScannedContractWhitelistRequest) GetAddress() string {
	if m != nil {
		return m.Address
	}
	return ""
...
type QueryGetScannedContractWhitelistResponse struct {
	ScannedContractWhitelist ScannedContractWhitelist `protobuf:"bytes,1,opt,name=scannedContractWhitelist,proto3" json:"scannedContractWhitelist"`
}

func (m *QueryGetScannedContractWhitelistResponse) Reset() {
	*m = QueryGetScannedContractWhitelistResponse{}
}
func (m *QueryGetScannedContractWhitelistResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGetScannedContractWhitelistResponse) ProtoMessage()    {}
func (*QueryGetScannedContractWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{67}
}
func (m *QueryGetScannedContractWhitelistResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetScannedContractWhitelistResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetScannedContractWhitelistResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetScannedContractWhitelistResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetScannedContractWhitelistResponse.Merge(m, src)
}
func (m *QueryGetScannedContractWhitelistResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetScannedContractWhitelistResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetScannedContractWhitelistResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetScannedContractWhitelistResponse proto.InternalMessageInfo

func (m *QueryGetScannedContractWhitelistResponse) GetScannedContractWhitelist() ScannedContractWhitelist {
	if m != nil {
		return m.ScannedContractWhitelist
	}
	return ScannedContractWhitelist{}
}

type QueryAllScannedContractWhitelistRequest struct {
	Pagination *query.PageRequest `protobuf:"bytes,1,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryAllScannedContractWhitelistRequest) Reset() {
	*m = QueryAllScannedContractWhitelistRequest{}
}
func (m *QueryAllScannedContractWhitelistRequest) String() string { return proto.CompactTextString(m) }
func (*QueryAllScannedContractWhitelistRequest) ProtoMessage()    {}
func (*QueryAllScannedContractWhitelistRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{68}
}
func (m *QueryAllScannedContractWhitelistRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryAllScannedContractWhitelistRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryAllScannedContractWhitelistRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryAllScannedContractWhitelistRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryAllScannedContractWhitelistRequest.Merge(m, src)
}
func (m *QueryAllScannedContractWhitelistRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryAllScannedContractWhitelistRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryAllScannedContractWhitelistRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryAllScannedContractWhitelistRequest proto.InternalMessageInfo

func (m *QueryAllScannedContractWhitelistRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryAllScannedContractWhitelistResponse struct {
	ScannedContractWhitelist []ScannedContractWhitelist `protobuf:"bytes,1,rep,name=scannedContractWhitelist,proto3" json:"scannedContractWhitelist"`
	Pagination               *query.PageResponse        `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryAllScannedContractWhitelistResponse) Reset() {
	*m = QueryAllScannedContractWhitelistResponse{}
}
func (m *QueryAllScannedContractWhitelistResponse) String() string { return proto.CompactTextString(m) }
func (*QueryAllScannedContractWhitelistResponse) ProtoMessage()    {}
func (*QueryAllScannedContractWhitelistResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{69}
}
func (m *QueryAllScannedContractWhitelistResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryAllScannedContractWhitelistResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryAllScannedContractWhitelistResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryAllScannedContractWhitelistResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryAllScannedContractWhitelistResponse.Merge(m, src)
}
func (m *QueryAllScannedContractWhitelistResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryAllScannedContractWhitelistResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryAllScannedContractWhitelistResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryAllScannedContractWhitelistResponse proto.InternalMessageInfo

func (m *QueryAllScannedContractWhitelistResponse) GetScannedContractWhitelist() []ScannedContractWhitelist {
	if m != nil {
		return m.ScannedContractWhitelist
	}
	return nil
...
func (m *QueryAllScannedContractWhitelistResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryGetParkedExternalAddressRequest struct {
	// The pioneer row's PubKID: the pioneer account address, which is also the validator operator's
	// account (the CLI accepts a qadenavaloper address too and converts it).
	PubKID string `protobuf:"bytes,1,opt,name=pubKID,proto3" json:"pubKID,omitempty"`
}

func (m *QueryGetParkedExternalAddressRequest) Reset()         { *m = QueryGetParkedExternalAddressRequest{} }
func (m *QueryGetParkedExternalAddressRequest) String() string { return proto.CompactTextString(m) }
func (*QueryGetParkedExternalAddressRequest) ProtoMessage()    {}
func (*QueryGetParkedExternalAddressRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{70}
}
func (m *QueryGetParkedExternalAddressRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetParkedExternalAddressRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetParkedExternalAddressRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetParkedExternalAddressRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetParkedExternalAddressRequest.Merge(m, src)
}
func (m *QueryGetParkedExternalAddressRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetParkedExternalAddressRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetParkedExternalAddressRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetParkedExternalAddressRequest proto.InternalMessageInfo

func (m *QueryGetParkedExternalAddressRequest) GetPubKID() string {
	if m != nil {
		return m.PubKID
	}
	return ""
...
type QueryGetParkedExternalAddressResponse struct {
	ParkedExternalAddress ParkedExternalAddress `protobuf:"bytes,1,opt,name=parkedExternalAddress,proto3" json:"parkedExternalAddress"`
}

func (m *QueryGetParkedExternalAddressResponse) Reset()         { *m = QueryGetParkedExternalAddressResponse{} }
func (m *QueryGetParkedExternalAddressResponse) String() string { return proto.CompactTextString(m) }
func (*QueryGetParkedExternalAddressResponse) ProtoMessage()    {}
func (*QueryGetParkedExternalAddressResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{71}
}
func (m *QueryGetParkedExternalAddressResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryGetParkedExternalAddressResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryGetParkedExternalAddressResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryGetParkedExternalAddressResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryGetParkedExternalAddressResponse.Merge(m, src)
}
func (m *QueryGetParkedExternalAddressResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryGetParkedExternalAddressResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryGetParkedExternalAddressResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryGetParkedExternalAddressResponse proto.InternalMessageInfo

func (m *QueryGetParkedExternalAddressResponse) GetParkedExternalAddress() ParkedExternalAddress {
	if m != nil {
		return m.ParkedExternalAddress
	}
	return ParkedExternalAddress{}
}

type QueryAllParkedExternalAddressRequest struct {
	Pagination *query.PageRequest `protobuf:"bytes,1,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryAllParkedExternalAddressRequest) Reset()         { *m = QueryAllParkedExternalAddressRequest{} }
func (m *QueryAllParkedExternalAddressRequest) String() string { return proto.CompactTextString(m) }
func (*QueryAllParkedExternalAddressRequest) ProtoMessage()    {}
func (*QueryAllParkedExternalAddressRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{72}
}
func (m *QueryAllParkedExternalAddressRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryAllParkedExternalAddressRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryAllParkedExternalAddressRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryAllParkedExternalAddressRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryAllParkedExternalAddressRequest.Merge(m, src)
}
func (m *QueryAllParkedExternalAddressRequest) XXX_Size() int {
	return m.Size()
}
func (m *QueryAllParkedExternalAddressRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryAllParkedExternalAddressRequest.DiscardUnknown(m)
}

var xxx_messageInfo_QueryAllParkedExternalAddressRequest proto.InternalMessageInfo

func (m *QueryAllParkedExternalAddressRequest) GetPagination() *query.PageRequest {
	if m != nil {
		return m.Pagination
	}
	return nil
...
type QueryAllParkedExternalAddressResponse struct {
	ParkedExternalAddress []ParkedExternalAddress `protobuf:"bytes,1,rep,name=parkedExternalAddress,proto3" json:"parkedExternalAddress"`
	Pagination            *query.PageResponse     `protobuf:"bytes,2,opt,name=pagination,proto3" json:"pagination,omitempty"`
}

func (m *QueryAllParkedExternalAddressResponse) Reset()         { *m = QueryAllParkedExternalAddressResponse{} }
func (m *QueryAllParkedExternalAddressResponse) String() string { return proto.CompactTextString(m) }
func (*QueryAllParkedExternalAddressResponse) ProtoMessage()    {}
func (*QueryAllParkedExternalAddressResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_f6288880fbccdff5, []int{73}
}
func (m *QueryAllParkedExternalAddressResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *QueryAllParkedExternalAddressResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_QueryAllParkedExternalAddressResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *QueryAllParkedExternalAddressResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_QueryAllParkedExternalAddressResponse.Merge(m, src)
}
func (m *QueryAllParkedExternalAddressResponse) XXX_Size() int {
	return m.Size()
}
func (m *QueryAllParkedExternalAddressResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_QueryAllParkedExternalAddressResponse.DiscardUnknown(m)
}

var xxx_messageInfo_QueryAllParkedExternalAddressResponse proto.InternalMessageInfo

func (m *QueryAllParkedExternalAddressResponse) GetParkedExternalAddress() []ParkedExternalAddress {
	if m != nil {
		return m.ParkedExternalAddress
	}
	return nil
...
func (m *QueryAllParkedExternalAddressResponse) GetPagination() *query.PageResponse {
	if m != nil {
		return m.Pagination
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*QueryEnclaveMeasurementRequest)(nil), "qadena.qadena.QueryEnclaveMeasurementRequest")
	proto.RegisterType((*QueryEnclaveMeasurementResponse)(nil), "qadena.qadena.QueryEnclaveMeasurementResponse")
	...
	proto.RegisterType((*QueryEnclavePrivateStateRequest)(nil), "qadena.qadena.QueryEnclavePrivateStateRequest")
	proto.RegisterType((*QueryEnclavePrivateStateResponse)(nil), "qadena.qadena.QueryEnclavePrivateStateResponse")
	proto.RegisterType((*QueryEnclavePrivateStateAvailabilityRequest)(nil), "qadena.qadena.QueryEnclavePrivateStateAvailabilityRequest")
	proto.RegisterType((*QueryEnclavePrivateStateAvailabilityResponse)(nil), "qadena.qadena.QueryEnclavePrivateStateAvailabilityResponse")
	...
	proto.RegisterType((*QueryEnclaveSecretSharePrivKRequest)(nil), "qadena.qadena.QueryEnclaveSecretSharePrivKRequest")
	proto.RegisterType((*QueryEnclaveSecretSharePrivKResponse)(nil), "qadena.qadena.QueryEnclaveSecretSharePrivKResponse")
	...
	proto.RegisterType((*QueryGetScannedContractWhitelistRequest)(nil), "qadena.qadena.QueryGetScannedContractWhitelistRequest")
	proto.RegisterType((*QueryGetScannedContractWhitelistResponse)(nil), "qadena.qadena.QueryGetScannedContractWhitelistResponse")
	proto.RegisterType((*QueryAllScannedContractWhitelistRequest)(nil), "qadena.qadena.QueryAllScannedContractWhitelistRequest")
	proto.RegisterType((*QueryAllScannedContractWhitelistResponse)(nil), "qadena.qadena.QueryAllScannedContractWhitelistResponse")
	proto.RegisterType((*QueryGetParkedExternalAddressRequest)(nil), "qadena.qadena.QueryGetParkedExternalAddressRequest")
	proto.RegisterType((*QueryGetParkedExternalAddressResponse)(nil), "qadena.qadena.QueryGetParkedExternalAddressResponse")
	proto.RegisterType((*QueryAllParkedExternalAddressRequest)(nil), "qadena.qadena.QueryAllParkedExternalAddressRequest")
	proto.RegisterType((*QueryAllParkedExternalAddressResponse)(nil), "qadena.qadena.QueryAllParkedExternalAddressResponse")
}
...
var fileDescriptor_f6288880fbccdff5 = []byte{
	...
	,
}
...
type QueryClient interface {
	...
	// Serves this node's enclave-private tables at a height to an attested peer enclave.  No REST
	// gateway route: the request carries an opaque binary cursor that has no sane URL encoding, and
	// the only intended caller is another enclave over gRPC.
	EnclavePrivateState(ctx context.Context, in *QueryEnclavePrivateStateRequest, opts ...grpc.CallOption) (*QueryEnclavePrivateStateResponse, error)
	// WHO-HAS: serves a CACHED interval private key to an attested peer enclave, for keys whose
	// share-owners can no longer reach threshold.  Same trust bar as EnclaveSecretShare and
	// sync-enclave (which ships jar/regulator private keys); enclave-to-enclave only, no REST route.
	EnclaveSecretSharePrivK(ctx context.Context, in *QueryEnclaveSecretSharePrivKRequest, opts ...grpc.CallOption) (*QueryEnclaveSecretSharePrivKResponse, error)
	// Which heights this node's enclave can serve private state for.  Unattested on purpose: it
	// carries no secrets, and a peer that lies about its range costs the caller only a wasted
	// attempt -- the transfer itself fails closed.
	EnclavePrivateStateAvailability(ctx context.Context, in *QueryEnclavePrivateStateAvailabilityRequest, opts ...grpc.CallOption) (*QueryEnclavePrivateStateAvailabilityResponse, error)
	...
	// What enclave build is this node running?  Unauthenticated on purpose: a measurement is not a
	// secret -- it is written into genesis and published on chain as an EnclaveIdentity -- and the
	// caller needs it BEFORE it can attest anything, which is the whole point.
	//
	// add_full_node.sh asks the seed this and compares it with the joiner's own before minting keys.
	// A joiner can only bootstrap its trusted set from a seed running its own measurement, so a
	// mismatch means sync-enclave will refuse; without this the operator finds out several minutes
	// in, from a rejected handshake that names neither side's build.
	EnclaveMeasurement(ctx context.Context, in *QueryEnclaveMeasurementRequest, opts ...grpc.CallOption) (*QueryEnclaveMeasurementResponse, error)
	...
	// Queries the scanned-contract whitelist.
	//
	// Needed operationally, not just for inspection: adding an entry is a governance proposal, and
	// the scripts that submit one have to be able to tell "already listed" from "not listed yet" --
	// MsgAddScannedContractWhitelist rejects duplicates, so a re-run without this check would fail a
	// proposal against an already-correct chain.
	ScannedContractWhitelist(ctx context.Context, in *QueryGetScannedContractWhitelistRequest, opts ...grpc.CallOption) (*QueryGetScannedContractWhitelistResponse, error)
	ScannedContractWhitelistAll(ctx context.Context, in *QueryAllScannedContractWhitelistRequest, opts ...grpc.CallOption) (*QueryAllScannedContractWhitelistResponse, error)
	// Queries the addresses the staking hooks have parked -- pioneers whose validator left the
	// bonded set, with the ExternalIPAddress that will be put back when it re-bonds.
	//
	// Needed operationally: "why is this bonded pioneer not addressable" has no other answer short
	// of a genesis export (which needs the node stopped) or a raw abci_query against a hand-built
	// key.  An entry here for a validator that is BONDED means a restore has not happened yet --
	// the one state an operator would otherwise have no way to see.
	ParkedExternalAddress(ctx context.Context, in *QueryGetParkedExternalAddressRequest, opts ...grpc.CallOption) (*QueryGetParkedExternalAddressResponse, error)
	ParkedExternalAddressAll(ctx context.Context, in *QueryAllParkedExternalAddressRequest, opts ...grpc.CallOption) (*QueryAllParkedExternalAddressResponse, error)
}
...
func (c *queryClient) EnclavePrivateState(ctx context.Context, in *QueryEnclavePrivateStateRequest, opts ...grpc.CallOption) (*QueryEnclavePrivateStateResponse, error) {
	out := new(QueryEnclavePrivateStateResponse)
	err := c.cc.Invoke(ctx, "/qadena.qadena.Query/EnclavePrivateState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EnclaveSecretSharePrivK(ctx context.Context, in *QueryEnclaveSecretSharePrivKRequest, opts ...grpc.CallOption) (*QueryEnclaveSecretSharePrivKResponse, error) {
	out := new(QueryEnclaveSecretSharePrivKResponse)
	err := c.cc.Invoke(ctx, "/qadena.qadena.Query/EnclaveSecretSharePrivK", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EnclavePrivateStateAvailability(ctx context.Context, in *QueryEnclavePrivateStateAvailabilityRequest, opts ...grpc.CallOption) (*QueryEnclavePrivateStateAvailabilityResponse, error) {
	out := new(QueryEnclavePrivateStateAvailabilityResponse)
	err := c.cc.Invoke(ctx, "/qadena.qadena.Query/EnclavePrivateStateAvailability", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) EnclaveMeasurement(ctx context.Context, in *QueryEnclaveMeasurementRequest, opts ...grpc.CallOption) (*QueryEnclaveMeasurementResponse, error) {
	out := new(QueryEnclaveMeasurementResponse)
	err := c.cc.Invoke(ctx, "/qadena.qadena.Query/EnclaveMeasurement", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ScannedContractWhitelist(ctx context.Context, in *QueryGetScannedContractWhitelistRequest, opts ...grpc.CallOption) (*QueryGetScannedContractWhitelistResponse, error) {
	out := new(QueryGetScannedContractWhitelistResponse)
	err := c.cc.Invoke(ctx, "/qadena.qadena.Query/ScannedContractWhitelist", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ScannedContractWhitelistAll(ctx context.Context, in *QueryAllScannedContractWhitelistRequest, opts ...grpc.CallOption) (*QueryAllScannedContractWhitelistResponse, error) {
	out := new(QueryAllScannedContractWhitelistResponse)
	err := c.cc.Invoke(ctx, "/qadena.qadena.Query/ScannedContractWhitelistAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ParkedExternalAddress(ctx context.Context, in *QueryGetParkedExternalAddressRequest, opts ...grpc.CallOption) (*QueryGetParkedExternalAddressResponse, error) {
	out := new(QueryGetParkedExternalAddressResponse)
	err := c.cc.Invoke(ctx, "/qadena.qadena.Query/ParkedExternalAddress", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ParkedExternalAddressAll(ctx context.Context, in *QueryAllParkedExternalAddressRequest, opts ...grpc.CallOption) (*QueryAllParkedExternalAddressResponse, error) {
	out := new(QueryAllParkedExternalAddressResponse)
	err := c.cc.Invoke(ctx, "/qadena.qadena.Query/ParkedExternalAddressAll", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type QueryServer interface {
	...
	// gateway route: the request carries an opaque binary cursor that has no sane URL encoding, and
	// the only intended caller is another enclave over gRPC.
	EnclavePrivateState(context.Context, *QueryEnclavePrivateStateRequest) (*QueryEnclavePrivateStateResponse, error)
	// WHO-HAS: serves a CACHED interval private key to an attested peer enclave, for keys whose
	// share-owners can no longer reach threshold.  Same trust bar as EnclaveSecretShare and
	// sync-enclave (which ships jar/regulator private keys); enclave-to-enclave only, no REST route.
	EnclaveSecretSharePrivK(context.Context, *QueryEnclaveSecretSharePrivKRequest) (*QueryEnclaveSecretSharePrivKResponse, error)
	// Which heights this node's enclave can serve private state for.  Unattested on purpose: it
	// carries no secrets, and a peer that lies about its range costs the caller only a wasted
	// attempt -- the transfer itself fails closed.
	EnclavePrivateStateAvailability(context.Context, *QueryEnclavePrivateStateAvailabilityRequest) (*QueryEnclavePrivateStateAvailabilityResponse, error)
	// Queries a list of EnclaveRecoverKeyShare items.
	...
	// mismatch means sync-enclave will refuse; without this the operator finds out several minutes
	// in, from a rejected handshake that names neither side's build.
	EnclaveMeasurement(context.Context, *QueryEnclaveMeasurementRequest) (*QueryEnclaveMeasurementResponse, error)
	// Queries a list of FindCredential items.
	...
	// MsgAddScannedContractWhitelist rejects duplicates, so a re-run without this check would fail a
	// proposal against an already-correct chain.
	ScannedContractWhitelist(context.Context, *QueryGetScannedContractWhitelistRequest) (*QueryGetScannedContractWhitelistResponse, error)
	ScannedContractWhitelistAll(context.Context, *QueryAllScannedContractWhitelistRequest) (*QueryAllScannedContractWhitelistResponse, error)
	// Queries the addresses the staking hooks have parked -- pioneers whose validator left the
	// bonded set, with the ExternalIPAddress that will be put back when it re-bonds.
	//
	// Needed operationally: "why is this bonded pioneer not addressable" has no other answer short
	...
	// key.  An entry here for a validator that is BONDED means a restore has not happened yet --
	// the one state an operator would otherwise have no way to see.
	ParkedExternalAddress(context.Context, *QueryGetParkedExternalAddressRequest) (*QueryGetParkedExternalAddressResponse, error)
	ParkedExternalAddressAll(context.Context, *QueryAllParkedExternalAddressRequest) (*QueryAllParkedExternalAddressResponse, error)
}
...
func (*UnimplementedQueryServer) EnclavePrivateState(ctx context.Context, req *QueryEnclavePrivateStateRequest) (*QueryEnclavePrivateStateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnclavePrivateState not implemented")
}
func (*UnimplementedQueryServer) EnclaveSecretSharePrivK(ctx context.Context, req *QueryEnclaveSecretSharePrivKRequest) (*QueryEnclaveSecretSharePrivKResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnclaveSecretSharePrivK not implemented")
}
func (*UnimplementedQueryServer) EnclavePrivateStateAvailability(ctx context.Context, req *QueryEnclavePrivateStateAvailabilityRequest) (*QueryEnclavePrivateStateAvailabilityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnclavePrivateStateAvailability not implemented")
}
...
func (*UnimplementedQueryServer) EnclaveMeasurement(ctx context.Context, req *QueryEnclaveMeasurementRequest) (*QueryEnclaveMeasurementResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method EnclaveMeasurement not implemented")
}
...
func (*UnimplementedQueryServer) ScannedContractWhitelist(ctx context.Context, req *QueryGetScannedContractWhitelistRequest) (*QueryGetScannedContractWhitelistResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ScannedContractWhitelist not implemented")
}
func (*UnimplementedQueryServer) ScannedContractWhitelistAll(ctx context.Context, req *QueryAllScannedContractWhitelistRequest) (*QueryAllScannedContractWhitelistResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ScannedContractWhitelistAll not implemented")
}
func (*UnimplementedQueryServer) ParkedExternalAddress(ctx context.Context, req *QueryGetParkedExternalAddressRequest) (*QueryGetParkedExternalAddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParkedExternalAddress not implemented")
}
func (*UnimplementedQueryServer) ParkedExternalAddressAll(ctx context.Context, req *QueryAllParkedExternalAddressRequest) (*QueryAllParkedExternalAddressResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ParkedExternalAddressAll not implemented")
}
...
func _Query_EnclavePrivateState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryEnclavePrivateStateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).EnclavePrivateState(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qadena.qadena.Query/EnclavePrivateState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).EnclavePrivateState(ctx, req.(*QueryEnclavePrivateStateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_EnclaveSecretSharePrivK_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryEnclaveSecretSharePrivKRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).EnclaveSecretSharePrivK(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qadena.qadena.Query/EnclaveSecretSharePrivK",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).EnclaveSecretSharePrivK(ctx, req.(*QueryEnclaveSecretSharePrivKRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_EnclavePrivateStateAvailability_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryEnclavePrivateStateAvailabilityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).EnclavePrivateStateAvailability(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qadena.qadena.Query/EnclavePrivateStateAvailability",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).EnclavePrivateStateAvailability(ctx, req.(*QueryEnclavePrivateStateAvailabilityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Query_EnclaveMeasurement_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryEnclaveMeasurementRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).EnclaveMeasurement(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qadena.qadena.Query/EnclaveMeasurement",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).EnclaveMeasurement(ctx, req.(*QueryEnclaveMeasurementRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Query_ScannedContractWhitelist_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryGetScannedContractWhitelistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).ScannedContractWhitelist(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qadena.qadena.Query/ScannedContractWhitelist",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ScannedContractWhitelist(ctx, req.(*QueryGetScannedContractWhitelistRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_ScannedContractWhitelistAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryAllScannedContractWhitelistRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).ScannedContractWhitelistAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qadena.qadena.Query/ScannedContractWhitelistAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ScannedContractWhitelistAll(ctx, req.(*QueryAllScannedContractWhitelistRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_ParkedExternalAddress_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryGetParkedExternalAddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).ParkedExternalAddress(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qadena.qadena.Query/ParkedExternalAddress",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ParkedExternalAddress(ctx, req.(*QueryGetParkedExternalAddressRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Query_ParkedExternalAddressAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(QueryAllParkedExternalAddressRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(QueryServer).ParkedExternalAddressAll(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/qadena.qadena.Query/ParkedExternalAddressAll",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(QueryServer).ParkedExternalAddressAll(ctx, req.(*QueryAllParkedExternalAddressRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Query_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "EnclavePrivateState",
			Handler:    _Query_EnclavePrivateState_Handler,
		},
		{
			MethodName: "EnclaveSecretSharePrivK",
			Handler:    _Query_EnclaveSecretSharePrivK_Handler,
		},
		{
			MethodName: "EnclavePrivateStateAvailability",
			Handler:    _Query_EnclavePrivateStateAvailability_Handler,
		},
		{
		...
		{
			MethodName: "EnclaveMeasurement",
			Handler:    _Query_EnclaveMeasurement_Handler,
		},
		{
		...
		{
			MethodName: "ScannedContractWhitelist",
			Handler:    _Query_ScannedContractWhitelist_Handler,
		},
		{
			MethodName: "ScannedContractWhitelistAll",
			Handler:    _Query_ScannedContractWhitelistAll_Handler,
		},
		{
			MethodName: "ParkedExternalAddress",
			Handler:    _Query_ParkedExternalAddress_Handler,
		},
		{
			MethodName: "ParkedExternalAddressAll",
			Handler:    _Query_ParkedExternalAddressAll_Handler,
		},
	},
...
func (m *QueryEnclaveMeasurementRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryEnclaveMeasurementRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryEnclaveMeasurementRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryEnclaveMeasurementResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryEnclaveMeasurementResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryEnclaveMeasurementResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryEnclaveSyncEnclaveRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.MaxBytes != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.MaxBytes))
		i--
		dAtA[i] = 0x20
	}
	if len(m.Cursor) > 0 {
...
func (m *QueryEnclaveSyncEnclaveResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.EncSyncEnclavePagePubK) > 0 {
		i -= len(m.EncSyncEnclavePagePubK)
		copy(dAtA[i:], m.EncSyncEnclavePagePubK)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.EncSyncEnclavePagePubK)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *QueryEnclavePrivateStateRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryEnclavePrivateStateRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryEnclavePrivateStateRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.BlockTimeUnix != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.BlockTimeUnix))
		i--
		dAtA[i] = 0x28
	}
...
func (m *QueryEnclavePrivateStateResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryEnclavePrivateStateResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryEnclavePrivateStateResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.EncPrivateStatePagePubK) > 0 {
		i -= len(m.EncPrivateStatePagePubK)
		copy(dAtA[i:], m.EncPrivateStatePagePubK)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.EncPrivateStatePagePubK)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.RemoteReport) > 0 {
...
func (m *QueryEnclavePrivateStateAvailabilityRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryEnclavePrivateStateAvailabilityRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryEnclavePrivateStateAvailabilityRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryEnclavePrivateStateAvailabilityResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryEnclavePrivateStateAvailabilityResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryEnclavePrivateStateAvailabilityResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.PreparedHeight != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.PreparedHeight))
		i--
		dAtA[i] = 0x10
	}
	if m.EarliestHeight != 0 {
		i = encodeVarintQuery(dAtA, i, uint64(m.EarliestHeight))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *QueryEnclaveSecretSharePrivKRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryEnclaveSecretSharePrivKRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryEnclaveSecretSharePrivKRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryEnclaveSecretSharePrivKResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryEnclaveSecretSharePrivKResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryEnclaveSecretSharePrivKResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.EncPrivKEnclavePubK) > 0 {
		i -= len(m.EncPrivKEnclavePubK)
		copy(dAtA[i:], m.EncPrivKEnclavePubK)
		i = encodeVarintQuery(dAtA, i, uint64(len(m.EncPrivKEnclavePubK)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.RemoteReport) > 0 {
...
func (m *QueryGetScannedContractWhitelistRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetScannedContractWhitelistRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetScannedContractWhitelistRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGetScannedContractWhitelistResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetScannedContractWhitelistResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetScannedContractWhitelistResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.ScannedContractWhitelist.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *QueryAllScannedContractWhitelistRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryAllScannedContractWhitelistRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryAllScannedContractWhitelistRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryAllScannedContractWhitelistResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryAllScannedContractWhitelistResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryAllScannedContractWhitelistResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ScannedContractWhitelist) > 0 {
		for iNdEx := len(m.ScannedContractWhitelist) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ScannedContractWhitelist[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryGetParkedExternalAddressRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetParkedExternalAddressRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetParkedExternalAddressRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryGetParkedExternalAddressResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryGetParkedExternalAddressResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryGetParkedExternalAddressResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	{
		size, err := m.ParkedExternalAddress.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
...
func (m *QueryAllParkedExternalAddressRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryAllParkedExternalAddressRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryAllParkedExternalAddressRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *QueryAllParkedExternalAddressResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *QueryAllParkedExternalAddressResponse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *QueryAllParkedExternalAddressResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ParkedExternalAddress) > 0 {
		for iNdEx := len(m.ParkedExternalAddress) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.ParkedExternalAddress[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *QueryEnclaveMeasurementRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryEnclaveMeasurementResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryEnclaveSyncEnclaveRequest) Size() (n int) {
	...
	if m.MaxBytes != 0 {
		n += 1 + sovQuery(uint64(m.MaxBytes))
	}
	return n
}
...
func (m *QueryEnclaveSyncEnclaveResponse) Size() (n int) {
	...
	l = len(m.EncSyncEnclavePagePubK)
	if l > 0 {
		n += 1 + l + sovQuery(uint64(l))
	}
	return n
...
func (m *QueryEnclavePrivateStateRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.BlockTimeUnix != 0 {
		n += 1 + sovQuery(uint64(m.BlockTimeUnix))
	}
	l = len(m.Cursor)
	if l > 0 {
		n += 1 + l + sovQuery(uint64(l))
...
func (m *QueryEnclavePrivateStateResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	l = len(m.EncPrivateStatePagePubK)
	if l > 0 {
		n += 1 + l + sovQuery(uint64(l))
	}
	return n
...
func (m *QueryEnclavePrivateStateAvailabilityRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryEnclavePrivateStateAvailabilityResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.EarliestHeight != 0 {
		n += 1 + sovQuery(uint64(m.EarliestHeight))
	}
	if m.PreparedHeight != 0 {
		n += 1 + sovQuery(uint64(m.PreparedHeight))
	}
	if m.SchemaVersion != 0 {
...
func (m *QueryEnclaveSecretSharePrivKRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryEnclaveSecretSharePrivKResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetScannedContractWhitelistRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetScannedContractWhitelistResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.ScannedContractWhitelist.Size()
	n += 1 + l + sovQuery(uint64(l))
	return n
}

func (m *QueryAllScannedContractWhitelistRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryAllScannedContractWhitelistResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.ScannedContractWhitelist) > 0 {
		for _, e := range m.ScannedContractWhitelist {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryGetParkedExternalAddressRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryGetParkedExternalAddressResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.ParkedExternalAddress.Size()
	n += 1 + l + sovQuery(uint64(l))
	return n
}

func (m *QueryAllParkedExternalAddressRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *QueryAllParkedExternalAddressResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if len(m.ParkedExternalAddress) > 0 {
		for _, e := range m.ParkedExternalAddress {
			l = e.Size()
			n += 1 + l + sovQuery(uint64(l))
		}
	}
...
func (m *QueryEnclaveMeasurementRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryEnclaveMeasurementRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryEnclaveMeasurementRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryEnclaveMeasurementResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryEnclaveMeasurementResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryEnclaveMeasurementResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryEnclaveSyncEnclaveResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncSyncEnclavePagePubK", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EncSyncEnclavePagePubK = append(m.EncSyncEnclavePagePubK[:0], dAtA[iNdEx:postIndex]...)
			if m.EncSyncEnclavePagePubK == nil {
				m.EncSyncEnclavePagePubK = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *QueryEnclavePrivateStateRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryEnclavePrivateStateRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryEnclavePrivateStateRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryEnclavePrivateStateResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryEnclavePrivateStateResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryEnclavePrivateStateResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncPrivateStatePagePubK", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EncPrivateStatePagePubK = append(m.EncPrivateStatePagePubK[:0], dAtA[iNdEx:postIndex]...)
			if m.EncPrivateStatePagePubK == nil {
				m.EncPrivateStatePagePubK = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *QueryEnclavePrivateStateAvailabilityRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryEnclavePrivateStateAvailabilityRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryEnclavePrivateStateAvailabilityRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		default:
			iNdEx = preIndex
...
func (m *QueryEnclavePrivateStateAvailabilityResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryEnclavePrivateStateAvailabilityResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryEnclavePrivateStateAvailabilityResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *QueryEnclaveSecretSharePrivKRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryEnclaveSecretSharePrivKRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryEnclaveSecretSharePrivKRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryEnclaveSecretSharePrivKResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryEnclaveSecretSharePrivKResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryEnclaveSecretSharePrivKResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EncPrivKEnclavePubK", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EncPrivKEnclavePubK = append(m.EncPrivKEnclavePubK[:0], dAtA[iNdEx:postIndex]...)
			if m.EncPrivKEnclavePubK == nil {
				m.EncPrivKEnclavePubK = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *QueryGetScannedContractWhitelistRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetScannedContractWhitelistRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetScannedContractWhitelistRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryGetScannedContractWhitelistResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetScannedContractWhitelistResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetScannedContractWhitelistResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ScannedContractWhitelist", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ScannedContractWhitelist.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QueryAllScannedContractWhitelistRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryAllScannedContractWhitelistRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryAllScannedContractWhitelistRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryAllScannedContractWhitelistResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryAllScannedContractWhitelistResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryAllScannedContractWhitelistResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.ScannedContractWhitelist = append(m.ScannedContractWhitelist, ScannedContractWhitelist{})
			if err := m.ScannedContractWhitelist[len(m.ScannedContractWhitelist)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
...
func (m *QueryGetParkedExternalAddressRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetParkedExternalAddressRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetParkedExternalAddressRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryGetParkedExternalAddressResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryGetParkedExternalAddressResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryGetParkedExternalAddressResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ParkedExternalAddress", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.ParkedExternalAddress.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *QueryAllParkedExternalAddressRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryAllParkedExternalAddressRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryAllParkedExternalAddressRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *QueryAllParkedExternalAddressResponse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: QueryAllParkedExternalAddressResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: QueryAllParkedExternalAddressResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.ParkedExternalAddress = append(m.ParkedExternalAddress, ParkedExternalAddress{})
			if err := m.ParkedExternalAddress[len(m.ParkedExternalAddress)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
