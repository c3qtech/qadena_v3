...
import (
	...
	modulev1 "github.com/c3qtech/qadena_v3/api/qadena/qadena/module"
...
func (AppModuleBasic) RegisterGRPCGatewayRoutes(clientCtx client.Context, mux *runtime.ServeMux) {
	...
	if err != nil {
		panic("Couldn't get node")
	}
	nodeStatus, err := node.Status(context.Background())
	if err != nil {
		panic("Couldn't get node status")
	}

	//  fmt.Println("GetNode", c.PrettyPrint(nodeStatus))
	keeper.SetValidatorAddress(nodeStatus.ValidatorInfo.Address.String())
