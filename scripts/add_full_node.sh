...
echo ""
echo "  For full node:"
echo "    $QADENAHOME/bin/qadenad --home $QADENAHOME tx bank send treasury $PIONEERADDRESS ${FULL}qdn --yes --gas-prices $minimum_gas_prices --gas auto --gas-adjustment $gas_adjustment"
echo "  For validator node:"
echo "    $QADENAHOME/bin/qadenad --home $QADENAHOME tx bank send treasury $PIONEERADDRESS ${VALIDATOR}qdn --yes --gas-prices $minimum_gas_prices --gas auto --gas-adjustment $gas_adjustment"
echo ""
