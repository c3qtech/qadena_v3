...
func (app *App) registerIBCAndWASMModules(appOpts servertypes.AppOptions, wasmOpts []wasmkeeper.Option) error {
...
func RegisterIBCAndWASM(registry cdctypes.InterfaceRegistry) map[string]appmodule.AppModule {
